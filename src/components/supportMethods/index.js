    ...
    return (
        <div>
            <h2 style={{
                ...
                Want to help us <span style={{fontSize: "200px"}}>help</span> those in need? 
            ...
            <div>
                <span>
                    ...
                    style={{color: "#FA8072", paddingLeft: "5px", fontSize: "50px", fontFamily: "fantasy"}}
                    >GoFundMe</Link>
                </span>
            </div>
            <div>
            ...
            <div>
                <span>
                    ...
                    <span style={{
                        ...
                        Donate Via <span style={{color: "#FA8072", fontSize: "50px", fontFamily: "fantasy"}}> Check </span>, Account set and administered by the association.
                    </span>
